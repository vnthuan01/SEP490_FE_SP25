      ...
      <div className="fixed inset-0 z-50 bg-background flex flex-col">
        ...
        <div className="flex-1 relative overflow-hidden">
          ...
          <button
            ...
            className="absolute top-4 right-4 z-20 bg-primary text-primary-foreground px-2 py-2 flex flex-center rounded-lg shadow-lg hover:bg-primary/90 transition-all"
            title={showSidebar ? 'Ẩn danh sách' : 'Hiện danh sách'}
          >
            <span className="material-symbols-outlined">{showSidebar ? 'close' : 'list'}</span>
          </button>
