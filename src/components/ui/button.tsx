  ...
  'cursor-pointer group whitespace-nowrap focus-visible:outline-hidden inline-flex items-center justify-center has-data-[arrow=true]:justify-between whitespace-nowrap text-sm font-medium ring-offset-background transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-60 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        primary:
          'bg-primary/70 text-primary-foreground hover:bg-primary data-[state=open]:bg-primary/60 dark:text-white',
        warning:
          'bg-yellow-500 text-white hover:bg-yellow-600/90 data-[state=open]:bg-yellow-600/90',
        ...
        outline:
          'bg-background text-foreground border border-border hover:bg-accent hover:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground',
        dashed:
          'bg-background text-foreground border border-border border-dashed hover:bg-accent/10 hover:text-accent-foreground data-[state=open]:bg-accent/10 data-[state=open]:text-accent-foreground',
        ghost:
          'bg-transparent text-foreground hover:bg-accent/10 hover:text-foreground data-[state=open]:bg-accent/10 data-[state=open]:text-foreground',
