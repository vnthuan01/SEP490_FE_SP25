  ...
  'inline-flex items-center justify-center border border-transparent font-medium focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 [&_svg]:-ms-px [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        /* --- 🎉 NEW VARIANTS --- */
        professor: 'bg-[#DBEAFE] text-[#1E40AF]', // xanh dương nhạt
        premium: 'bg-[#FEF9C3] text-[#B45309]', // vàng nhạt
        supporter: 'bg-[#EDE9FE] text-[#6D28D9]', // tím nhạt
      },
    ...
    compoundVariants: [
      ...
      /* --- 🎉 NEW OUTLINE VARIANTS --- */
      {
        variant: 'professor',
        appearance: 'outline',
        className: 'border-[#BFDBFE] bg-[#EFF6FF] text-[#1E3A8A]',
      },
      {
        variant: 'premium',
        appearance: 'outline',
      ...
      /* --- EXISTING GHOST VARIANTS --- */
      // ghost: no background, only text color
      ...
      /* --- 🎉 NEW GHOST VARIANTS --- */
      { variant: 'professor', appearance: 'ghost', className: 'text-[#1E40AF]' },
      { variant: 'premium', appearance: 'ghost', className: 'text-[#B45309]' },
      { variant: 'supporter', appearance: 'ghost', className: 'text-[#6D28D9]' },
